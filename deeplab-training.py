...
cfg = Config.fromfile('configs/deeplabv3plus/deeplabv3plus_r101-d8_480x480_40k_pascal_context.py')
...
cfg.data.train.split = '/data/dentdata/splits_org/train.txt'
...
cfg.data.val.split = '/data/dentdata/splits_org/valid.txt'
...
cfg.data.test.split = '/data/dentdata/splits_org/valid.txt'
